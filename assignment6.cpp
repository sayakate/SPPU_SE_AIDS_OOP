...
class student
{
 public:
                        ...
                        bool operator==(const student &student1)//&student1 = parameter object const=doesnt modify
                        {
...
vector<student>read()//vector is dynamic array that provide dynamic resizing ,making it flexible containet for storing element
            {
                        int n;
                        student k;     
                        vector<student>j;
...
int print( const vector <student> &j)
            {
